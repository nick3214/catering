...
<tbody>
<?php $sql = $dbcon->query("SELECT * FROM reservations WHERE user_id = '".$_SESSION['user_id']."' AND reservation_status != 'Draft' AND reservation_status != 'Cancelled'") or die(mysqli_error());?>
...
<tr>
  ...
  <td>
      ...
      ?window.location = \'reservations.php?delete='.$row['tcode'].'\' : \'\';"'; ?>>Delete</a></li>
