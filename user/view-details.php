...
<?php foreach ($package as $key => $value):?>
            <tr>
              ...
              <td>&#8369; <?php echo number_format($value->total_price *$code['pax'])?></td>
            </tr>
<?php endforeach;?>
<?php else:?>
<?php endif;?>
...
<?php endif;?>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <hr>
         <center>
             <a href="reservations.php" id="printbtn" class="btn btn-info" ><i class="fa fa-arrow-left"></i> Back</a>
             <a href="" id="printbtn" class="btn btn-warning" onclick="print()"><i class="fa fa-print"></i> Print Billing Statement</a>
