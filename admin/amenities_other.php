...
if(isset($_GET['delete'])){
  $delete = filter($_GET['delete']);
    ...
    if($del){
      header("location: amenities_other.php");
    }
}
?>
       ...
       <div class="container">
        ...
        <div class="box box-info" style="width:95.5%;">
            <div class="box-header">
              ...
              <h4 class="box-title"><i class="fa fa-list"></i> Amenities - </h4> <a href="add-amenity.php?type=1"><i class="fa fa-plus"></i> Create New</a><br><br>
