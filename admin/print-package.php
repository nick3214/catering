       ...
       <div class="container">
        ...
        <div class="box box-info" style="width:95.5%;">
            <div class="box-header">
              <h4 class="box-title"><i class="fa fa-list"></i> Package Report</h4>
              <hr>
<form method="get" target="_blank" action="preview-package.php">
  <select name="package" class="form-control">
    <!--
    <option value="0">Standard Package</option>
  -->
    <option value="1">Food Package</option>
    <!--
    <option value="2">Kiddie Package</option>
  -->
    <option value="3">Customize Package</option>
  </select><br>
