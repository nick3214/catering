...
if(isset($_POST['save_button']) AND !isset($_GET['paluto_id'])){
  ...
  $checkName = single_get("*","paluto_name","paluto_choice",$paluto_name);
  if($checkName['paluto_name'] == $paluto_name){
    ...
    insertdata("paluto_choice",$insertSQL);
    move_uploaded_file($_FILES["photo"]["tmp_name"],"../images/". $_FILES["photo"]["name"]);
    header("location: paluto_package.php");
  }
}
if(isset($_GET['paluto_id'])){
  $row = single_get("*","paluto_id","paluto_choice",$_GET['paluto_id']);
}
if(isset($_POST['save_button']) && isset($_GET['paluto_id'])){
  ...
  if($photo == ""){
    $update = $dbcon->query("UPDATE paluto_choice SET paluto_name='$paluto_name',
            ...
            <select name="paluto_type" class="form-control">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="paluto_choice.php" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back to list</a>
                  </td>
                </tr>
              </table>
              </form>
