       ...
       <div class="container">
        ...
        <div class="box box-info" style="width:95.5%;">
            <div class="box-header">
              <h4 class="box-title"><i class="fa fa-calendar"></i> Cancel Report</h4>
              <hr>
<form method="post">
...
<?php if(isset($_POST['sel_btn']) && $_POST['choice_type'] == '0'):?>
  <form method="get" target="_blank" action="cancel-month.php">
...
<?php elseif(isset($_POST['sel_btn']) && $_POST['choice_type'] == '1'):?>
  <form method="get" target="_blank" action="preview-cancel.php">
