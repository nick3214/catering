...
<?php if(isset($msg)):?><div class="alert alert-danger"><?php echo $msg;?></div><?php endif;?>
            ...
            <table class="table table-responsive table-bordered">
                <tr>
                  ...
                  <td>
                    ...
                    value="<?php if(isset($_GET['code']) && isset($_GET['edit']) == '1'): echo $row['package_name']; elseif(isset($_POST['save_button'])):echo $_GET['package']; else: echo $_GET['package']; endif;?>" readonly>
                  </td>
                </tr>
                <tr>
                  <td>Description:</td>
                  <td>
                    <textarea class="form-control" name="package_desc" readonly="readonly"><?php if(isset($_GET['code']) && isset($_GET['edit']) == '1'): echo $row['package_desc']; elseif(isset($_POST['save_button'])): echo $_GET['custom']; else: echo $_GET['custom']; endif;?>
                    </textarea>
      ...
      ?>
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" name="custom_fee" id="textthree" class="form-control" 
                    value="<?php echo $custom['setting_value']?>" readonly>
                  </td>
                  <td>Total Price:</td>
                  <td>
