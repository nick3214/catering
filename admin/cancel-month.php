...
$year = $_GET['year'];  
    $query = "SELECT * FROM reservations LEFT JOIN user_account on user_account.user_id = reservations.user_id WHERE YEAR(event_date) = '$year' AND MONTH(event_date) = '$month' AND (reservation_status = 'Cancelled')";
