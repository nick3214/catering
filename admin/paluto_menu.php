       ...
       <div class="container">
        ...
        <div class="box box-info" style="width:95.5%;">
            <div class="box-header">
              ...
              <h4 class="box-title"><i class="fa fa-list"></i> Paluto Menu - </h4> <a href="add_paluto.php"><i class="fa fa-plus"></i> Create New</a><br>
            </div>
            <div class="box-body">
              <div class="box">
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
          <?php 
          $sql = $dbcon->query("SELECT * FROM paluto_menu") or die(mysqli_error());
                ...
                <tr>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      <li><a href="add_paluto.php?paluto_id=<?php echo $row['paluto_id']?>">Edit</a></li>
                      <li><a href="#" <?php echo 'onclick=" confirm(\'Are you sure you want to delete?\') 
      ?window.location = \'paluto_menu.php?delete='.$row['paluto_id'].'\' : \'\';"'; ?>>Delete</a></li>
                    </ul>
                  </div>
                  </td>
                </tr>
