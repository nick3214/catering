...
<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/jquery-ui.min.js"></script>
       ...
       <div class="box box-info" style="width:97%;">
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="col-md-6">
                ...
                <br>
                <input type="text" name="reservation_name" class="form-control" placeholder="Customer Name" required="required" readonly="readonly" value="<?php echo $pName['reservation_name']?>">
              </div>
               <div class="col-md-6">
                <strong>Contact Number:</strong>
                <br>
                <input type="text" name="reservation_contact" class="form-control" placeholder="Contact Number" required="required" readonly="readonly" value="<?php echo $pName['reservation_contact']?>">
              </div>
             <?php endif;?>
              <div class="col-md-6">
            ...
            -->
             ...
             <!--
              <?php if($selectReserve['reservation_status'] == 'Draft'):?>
               ...
               <a href="checkout.php?tcode=<?php echo filter($_GET['tcode']);?>&payment_option=0" class="btn btn-warning"><i class="fa fa-file"></i> Pay Initial Deposit</a>
               
              <?php elseif($selectReserve['reservation_status'] == 'Paid Initially'):?>
                <a href="checkout.php?tcode=<?php echo filter($_GET['tcode']);?>&payment_option=2" class="btn btn-success"><i class="fa fa-shopping-cart"></i> Pay Remainig Balance</a>
              <?php else:?>
            ...
            <?php endif;?>
            <?php if($_GET['stat'] == 'walkin'):?>
              <a href="walkin-reservation.php" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back</a>
            <?php else:?>
              <a href="online-reservation.php" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back</a>
            <?php endif;?>        
              </div>
              <!-- /.tab-pane -->
  ...
  ?>
            ...
            <?php if($selectReserve['reservation_name'] != "" AND $selectReserve['reservation_status'] == 'Draft'):?>
            ...
            <?php  if($packages['p_type'] == '1' OR $packages['p_type'] == '0'){?>
              <h4>Additional Menu:</h4>
              <?php if($selectReserve['reservation_name'] != "" AND $selectReserve['reservation_status'] == 'Draft'):?>
              <a href="add-menu-walkin.php?tcode=<?php echo $_GET['tcode']?>" class="btn btn-info"><i class="fa fa-plus"></i> Add Menu</a>
              <?php endif;?>
              <br><br>
              <form method="post">
              <?php 
            ...
            <?php if($selectReserve['reservation_name'] != "" AND $selectReserve['reservation_status'] == 'Draft'):?>
              <a href="add-other.php?tcode=<?php echo $_GET['tcode']?>" class="btn btn-info"><i class="fa fa-plus"></i> Add Item</a>
            <?php endif;?>  
              <br>
              <br>
            ...
            <h4>Products</h4>
            <?php if($selectReserve['reservation_name'] != "" AND $selectReserve['reservation_status'] == 'Draft'):?>
            <a href="add-product.php?tcode=<?php echo $_GET['tcode']?>" class="btn btn-info"><i class="fa fa-plus"></i> Add Product</a>
            <?php endif;?><br><br>
            ...
            <?php if($selectReserve['reservation_name'] != "" AND $selectReserve['reservation_status'] == 'Draft'):?>
              <a href="add-pax.php?tcode=<?php echo $_GET['tcode']?>" class="btn btn-info"><i class="fa fa-plus"></i> Add Additional Pax</a>
            <?php endif;?>  
              <br>
              <br>
