...
if(isset($_POST['select_option1'])){
  ...
  if(isset($_GET['edit']) == '1'){
    header("location: kiddie-customization.php?code=".$code."&pack_type=".$_GET['pack_type']."&edit=1&kd=".$_GET['kd']."&custom=".$_GET['custom']."&package=".$_GET['package']."");
  }else{
    header("location: kiddie-customization.php?code=".$code."&pack_type=".$_GET['pack_type']."&kd=".$_GET['kd']."&custom=".$_GET['custom']."&package=".$_GET['package']."");
  }
...
?> 
            ...
            <table class="table table-responsive table-bordered">
                ...
                <?php $getTotal = $dbcon->query("SELECT SUM(ex_price) as total FROM package_extension WHERE code='".$_GET['code']."'") or die(mysqli_error());
                    ...
                    ?>
                    <input type="hidden" name="suggest_total" id="result2" class="form-control" readonly="readonly"
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <select  id="textone" class="form-control" name="per_head" readonly>
      <?php
 ...
 <td>No. of Kids</td>
                  <td>
                    <input type="text" name="no_kids" id = "kidsone" class="form-control" 
                  ...
                  <tr>
                   ...
                   <td>No. of Adults:</td>
                  <td>
                    <input type="text" name="no_adults" id="adultstwo" class="form-control" 
